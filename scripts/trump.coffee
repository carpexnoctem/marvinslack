...
#
# Commands:
#   hubot make america great again - Get a random Trump quote to brighten your life
#
# Author:
#   domingusj, tknodell
...
module.exports = (robot) ->
  robot.hear /make america great again|trump me/i, (msg) ->
    msg.send msg.random trumpQuotes
